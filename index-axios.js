...
// this whole file is task #3 instead of using fetch, I use axios
...
breedSelect.addEventListener("change", async () => {
    try {
        ...
        const response = await axios.get(`https://api.thecatapi.com/v1/images/search?breed_id=${breedSelect.value}&limit=5`);
        ...
        try {
            const breedResponse = await axios.get(`https://api.thecatapi.com/v1/images/${data[0].id}`);
